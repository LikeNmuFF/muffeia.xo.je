...
//
// NOTE: AES-256-CBC provides confidentiality only, without authentication (no HMAC).
// This means the ciphertext is vulnerable to padding oracle attacks and bit-flipping
// attacks by anyone who can intercept/modify messages. In a production environment,
// consider using AES-256-GCM (authenticated encryption) or adding an HMAC-SHA256
// over the ciphertext (encrypt-then-MAC).
//
// Additionally, generateConversationKey() derives keys from a deterministic seed,
// not from a true key exchange protocol. This is a simplified approach and not
