...
<head>
    ...
    <title>Server Error - MUFFEIA</title>
    ...
    <style>
        ...
        * {
        ...
        .error-icon {
            ...
            animation: shake 2s infinite, glow 3s ease-in-out infinite;
            transform: translateZ(40px);
            text-shadow: 0 0 30px var(--accent);
        }

        @keyframes shake {
            0%, 20%, 50%, 80%, 100% { transform: translateX(0) translateZ(40px); }
            10%, 30% { transform: translateX(-5px) translateZ(40px); }
            40%, 60% { transform: translateX(5px) translateZ(40px); }
        }

        @keyframes glow {
            0%, 100% { text-shadow: 0 0 20px var(--accent); }
            50% { text-shadow: 0 0 30px var(--accent), 0 0 40px var(--accent-light); }
        }
...
<body>
    ...
    <div class="error-container">
        ...
        <p class="error-message">
            ...
            Our engineering team has been alerted and is working to restore order to the universe.
        </p>
        ...
        <div class="btn-group">
            ...
            <a href="javascript:location.reload()" class="btn btn-accent">
